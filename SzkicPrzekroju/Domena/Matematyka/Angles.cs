...
namespace SzkicPrzekroju.Domena.Matematyka
{
    public static class Angles
    {
        ...
        public static double Angle(PointD p0, PointD p1)
        {
            double dx = p1.X - p0.X;
            double dy = p1.Y - p0.Y;
        ...
        public static double Angle(PointD p)
        {
        ...
        public static Boolean IsAcute(PointD p0, PointD p1, PointD p2)
        {
        ...
        /// <param name="p1">The base of the angle</param>
        /// <param name="p2">Another endpoint of the angle</param>
        public static Boolean IsObtuse(PointD p0, PointD p1, PointD p2)
        {
        ...
        public static double AngleBetween(PointD tip1, PointD tail, PointD tip2)
        {
        ...
        public static double AngleBetweenOriented(PointD tip1, PointD tail, PointD tip2)
        {
            double a1 = Angle(tail, tip1);
            double a2 = Angle(tail, tip2);
            double angDel = a2 - a1;
        ...
        public static double InteriorAngle(PointD p0, PointD p1, PointD p2)
        {
